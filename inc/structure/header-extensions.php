...
/****************************************************************************************/
//add_action('ambition_header', 'ambitionchild_headercontent_details', 10);
/**
 * Shows Header content details
 *
 * Shows the site logo, title, description, searchbar, social icons and many more
 */
function ambitionchild_headercontent_details() { ?>
	...
	<div class="hgroup-wrap">
		...
		<?php } else {// extract the content from page menu only ?>
			...
			if (is_front_page()) {
				...
				$disable_landingpage = $ambition_settings['disable_landingpage'];
				if(empty($disable_landingpage)) {

				  if(function_exists('ambitionchild_landingpage')) {
					  ambitionchild_landingpage();
				  }
				}
 ...
 *
 */
function ambitionchild_landingpage() {
	if ( is_front_page()) {
		echo get_template_part( 'landingpage-content' );
	}
}
endif;
/****************************************************************************************/
